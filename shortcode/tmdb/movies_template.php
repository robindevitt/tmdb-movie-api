...
if( !$movie->get_api_key() )
    echo '<div class="error">Please enter your API Key</div>';

echo $movie->movie_posters();
       

add_action( 'wp_footer', 'tmdb_footer_scripts' );
function tmdb_footer_scripts(){ 
    ?>
